<template>
    <div class="absolute top-0 left-0 grid w-full grid-cols-3 row-span-1 gap-8 p-6 pointer-events-none lg:grid-rows-1">
        <!-- Left: close + share -->
        <div class="flex grid-cols-1 gap-2 sm:gap-4 items-center">
            <button
                v-if="hasCloseBtn" class="flex items-center justify-center h-10 w-10 pointer-events-auto shrink-0"
            ...
            <!-- Share button -->
            <button
                class="relative flex items-center justify-center h-10 w-10 pointer-events-auto shrink-0"
        ...
        <!-- Right: logo aligned with buttons -->
        <div class="flex items-center justify-end pointer-events-auto">
            <a href="https://duckling.co" @click.stop>
                <img src="/duckling-logo.svg" class="h-10 w-10 object-contain" alt="Duckling" />
            </a>
        </div>
    </div>
</template>
