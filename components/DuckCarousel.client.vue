<template>
  ...
  <carousel ref="carouselRef" v-model="currentSlide" class="relative w-full h-full bg-duckling_black" :items-to-show="1"
    ...
    'bg-duckling_green': currentSlide == 0
      ...
      <div v-if="visualMode && currentSlide != 0" class="absolute top-0 right-0 pt-8 pr-8 header">
        <button class="w-12 h-12" @click="toggleVisualMode">
        ...
        <div class="w-full">
          <div class="grid h-full grid-cols-3">
            <div class="flex items-center justify-start w-full gap-2 sm:gap-4">
              ...
              <div id="profile" class="flex items-center row-span-1 gap-2 text-duckling_white shrink-0">
            ...
            <div class="flex items-center justify-center">
              <a href="https://duckling.co">
                <duckling-logo class="object-contain h-10 md:hidden" fill="#ffffff" fill-opacity="80%" />
                <duckling-logo class="hidden object-contain h-10 md:block" fill="#ffffff" fill-opacity="80%"
                  text-right />
              </a>
            </div>
